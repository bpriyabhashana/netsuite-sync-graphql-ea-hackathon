...
function getExpenseRecordTrandateByIDQuery(IncExpTrandateByIDRequestRecord incExpTrandateByIDRequestRecord) returns sql:ParameterizedQuery {
...
function getIncomeRecordTrandateByIDQuery(IncExpTrandateByIDRequestRecord incExpTrandateByIDRequestRecord) returns sql:ParameterizedQuery {
    return `SELECT trandate = ${incExpTrandateByIDRequestRecord.prevYearMonth} AS isPrevMonth
            FROM mis_income
            WHERE id = ${incExpTrandateByIDRequestRecord.id}`;
}

function updateNSIncomeAcValEachBULastMonthQuery(IncomeExpAcValUpdParameterRecord incomeExpAcValUpdParameterRecord)
